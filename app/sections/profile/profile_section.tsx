...
import BannerBackground from "./background";
      ...
      <div className="px-6 sm:px-12 pb-8 relative flex flex-col sm:flex-row items-center sm:items-start gap-6">
        ...
        <div className="pt-2 sm:pt-4 flex flex-col justify-center text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 mt-2">
            <button className="bg-cyan-500 dark:bg-gray-500 hover:bg-cyan-700 text-white text-sm px-4 py-2 rounded-md font-medium transition-colors font-semibold">
              See Portfolio
            </button>
            ...
            <div className="flex items-center gap-4 text-cyan-500 dark:text-gray-400">
              ...
              {/* GitHub */}
              <a href="https://github.com/ybunnn-dev" target="_blank" className="hover:text-header_text dark:hover:text-white transition-colors" aria-label="GitHub">
