...
const INITIAL_IMAGES = [
  { id: 1, src: "/pictures/week6/placeholder-1.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "WFH Setup" },
  { id: 2, src: "/pictures/week6/placeholder-2.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "Morning Onsite" },
  { id: 3, src: "/pictures/week6/placeholder-3.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "Backend Coding" },
  { id: 4, src: "/pictures/week6/placeholder-4.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "System Revisions" },
  { id: 5, src: "/pictures/week6/placeholder-5.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "Printer Disposal" },
  { id: 6, src: "/pictures/week6/placeholder-6.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "GAD Training" },
];
  ...
  return (
    <div className="w-full animate-fade-in">
      <div className="mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
        {/* UPDATED TITLE */}
        <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Week 6: Embracing Flexibility, Remote Work and Expanding My Perspective</h3>
        <p className="text-cyan-600 dark:text-cyan-400 font-medium mt-1">March 23, 2026 - March 26, 2026</p>
      </div>
      ...
      <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
        <p>
          During the sixth week, our team experienced a work-from-home setup due to a temporary disruption caused by a local strike. We still reported onsite in the morning when necessary and continued working remotely in the afternoon to maintain productivity.
        </p>
        <p>
          During this period, I continued backend development and made necessary revisions for the DOCS system. Because of the hybrid schedule, we were also tasked to prepare narrative reports to properly document our work-from-home arrangements and outputs.
        </p>
        <p>
          In addition to coding and documentation, I assisted in the disposal of old printers and attended a Gender and Development (GAD) training session. This seminar provided additional learning on workplace policies, equality, and important government initiatives.
        </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border-l-4 border-cyan-500 my-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><strong>Remote Work Productivity:</strong> Successfully managed a hybrid schedule (onsite mornings, remote afternoons) while maintaining development velocity.</li>
            <li><strong>Backend Development:</strong> Continued coding and iterating on the DOCS system backend.</li>
            <li><strong>Technical Documentation:</strong> Compiled detailed narrative reports to document WFH outputs and progress.</li>
            <li><strong>Workplace Development:</strong> Participated in Gender and Development (GAD) training, broadening understanding of government HR policies.</li>
          </ul>
        </div>
      </div>
    </div>
