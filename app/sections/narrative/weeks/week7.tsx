...
const INITIAL_IMAGES = [
  { id: 1, src: "/pictures/week7/placeholder-1.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "Holy Week Prep" },
  { id: 2, src: "/pictures/week7/placeholder-2.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "Mentorship Session" },
  ...
  return (
    <div className="w-full animate-fade-in">
      <div className="mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
        <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Week 7: Shortened Schedules and Bridging Frontend with Backend</h3>
        <p className="text-cyan-600 dark:text-cyan-400 font-medium mt-1">March 30, 2026 - April 1, 2026</p>
      </div>
      ...
      <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
        <p>
          During the seventh week, we followed a shortened three-day work schedule, with the third day shifted to a work-from-home arrangement in preparation for the Holy Week break.
        </p>
        <p>
          I participated in the sixth discussion with MIS mentors where we presented the DOCS Account Management and User Profile modules for evaluation. Feedback from these discussions guided further improvements in the system.
        </p>
        <p>
          I also continued frontend development while beginning the initial integration of backend functionalities into the system, marking an exciting transition toward a more complete system implementation.
        </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border-l-4 border-cyan-500 my-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><strong>Module Presentation:</strong> Presented the Account Management and User Profile UI to mentors for evaluation.</li>
            <li><strong>Full-Stack Transition:</strong> Began bridging the gap by integrating backend data with the existing frontend interfaces.</li>
            <li><strong>Agile Adaptation:</strong> Continued to iterate on system designs based on direct mentor feedback.</li>
            <li><strong>Schedule Management:</strong> Adapted to a shortened schedule and transitioned smoothly to a WFH setup for the holiday.</li>
          </ul>
        </div>
      </div>
    </div>
