...
const INITIAL_IMAGES = [
  { id: 1, src: "/pictures/week9/placeholder-1.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "STARBOOKS Data" },
  { id: 2, src: "/pictures/week9/placeholder-2.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "File Organization" },
  { id: 3, src: "/pictures/week9/placeholder-3.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "Pitch Event" },
  { id: 4, src: "/pictures/week9/placeholder-4.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "Research Seminar" },
  { id: 5, src: "/pictures/week9/placeholder-5.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "Gantt Charts" },
  { id: 6, src: "/pictures/week9/placeholder-6.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "InternNovation" },
];
  ...
  return (
    <div className="w-full animate-fade-in">
      <div className="mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
        <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Week 9: Organizing Resources and Preparing for InternNovation 2026</h3>
        <p className="text-cyan-600 dark:text-cyan-400 font-medium mt-1">April 13, 2026 - April 17, 2026</p>
      </div>
      ...
      <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
        <p>
          During the ninth week, I was tasked to assist in organizing and inventorying files for STARBOOKS, where I arranged all related documents by province in alphabetical order within Region V. This helped ensure proper documentation, easier retrieval, and more structured management of both digital and physical resources.
        </p>
        <p>
          I also participated in the "Saludo and 3-Minute Pitch to Policy Makers" event organized by the Bicol Consortium for Health Research and Development. Attending this event provided me with valuable exposure to formal research presentations and policy-oriented discussions.
        </p>
        <p>
          In relation to the DOCS project, development continued alongside the eighth discussion with MIS mentors, where we presented the system’s document management updates. This week also heavily reinforced our use of Gantt chart tracking and timeline monitoring in preparation for the upcoming InternNovation 2026 event.
        </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border-l-4 border-cyan-500 my-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><strong>Resource Management:</strong> Inventoried and structured STARBOOKS documents by province, improving data retrieval efficiency.</li>
            <li><strong>Professional Exposure:</strong> Gained insight into policy-making and formal presentations at a regional health research pitching event.</li>
            <li><strong>Project Management:</strong> Heavily utilized Gantt charts to track progress and ensure alignment with the upcoming InternNovation 2026 milestones.</li>
            <li><strong>System Development:</strong> Continued presenting and iterating on document management features during the eighth mentor evaluation.</li>
          </ul>
        </div>
      </div>
    </div>
