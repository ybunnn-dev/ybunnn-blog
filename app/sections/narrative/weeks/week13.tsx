  ...
  return (
    <div className="w-full animate-fade-in">
      <div className="mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
        <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Week 13: Final Preparations, Bootcamps, and Looking Ahead to InternNovation</h3>
        <p className="text-cyan-600 dark:text-cyan-400 font-medium mt-1">May 11, 2026 - May 15, 2026</p>
      </div>
      ...
      <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
        <p>
          During the final week of my internship, our team focused heavily on preparations for the upcoming InternNovation 2026 event scheduled for May 21st. The energy was high as we worked to finalize everything we had built over the past several months.
        </p>
        <p>
          This included continued system testing and refinement of the DOCS platform. I performed repeated test scenarios to identify any last-minute bugs, evaluate system stability, and ensure optimal functionality. We also conducted several practice sessions for the system presentation and anticipated Q&A to ensure we were fully ready for the final demonstration.
        </p>
        <p>
          In addition to our project prep, I attended the MIS and S&T Promotions’ "TUKDOST Innovation Bootcamp." This three-day event dove into critical IT topics like cybersecurity, phishing awareness, and bug hunting. During the second day, I also assisted the organizers by printing and distributing Customer Satisfaction Forms (CSF) to support the evaluation of the training activity.
        </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border-l-4 border-cyan-500 my-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><strong>Event Preparation:</strong> Rehearsed pitches and prepared for potential Q&A sessions for the InternNovation 2026 showcase.</li>
            <li><strong>Final Code Polish:</strong> Ran repetitive end-to-end tests to guarantee a stable and bug-free demonstration of DOCS.</li>
            <li><strong>Continuous Learning:</strong> Expanded knowledge on cybersecurity, phishing, and bug hunting at the 3-day TUKDOST Innovation Bootcamp.</li>
            <li><strong>Administrative Support:</strong> Assisted in event documentation by handling the distribution and collection of Customer Satisfaction Forms (CSF).</li>
          </ul>
        </div>
      </div>
    </div>
