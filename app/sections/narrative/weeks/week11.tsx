...
const INITIAL_IMAGES = [
  { id: 1, src: "/pictures/week11/placeholder-1.jpg", color: "bg-gray-400 dark:bg-gray-600", title: "PC Setup" },
  { id: 2, src: "/pictures/week11/placeholder-2.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "Printer Maintenance" },
  { id: 3, src: "/pictures/week11/placeholder-3.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "Network Fixes" },
  { id: 4, src: "/pictures/week11/placeholder-4.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "MIS Meeting" },
  { id: 5, src: "/pictures/week11/placeholder-5.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "System Refinement" },
  { id: 6, src: "/pictures/week11/placeholder-6.jpeg", color: "bg-gray-400 dark:bg-gray-600", title: "Friday WFH" },
];
  ...
  return (
    <div className="w-full animate-fade-in">
      <div className="mb-6 border-b border-gray-200 dark:border-gray-700 pb-4">
        <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Week 11: Balancing Technical Support and System Refinement</h3>
        <p className="text-cyan-600 dark:text-cyan-400 font-medium mt-1">April 27, 2026 - April 30, 2026</p>
      </div>
      ...
      <div className="space-y-5 text-gray-700 dark:text-gray-300 leading-relaxed text-sm sm:text-base">
        <p>
          During the eleventh week, I continued working on DOCS development while also taking on various technical support responsibilities within the Finance and Administrative Services (FAS) division. Stepping away from the code to help with hands-on tasks provided a nice change of pace.
        </p>
        <p>
          My support tasks included setting up computers, performing routine printer maintenance, and troubleshooting internet connectivity issues, ensuring that the daily operations of the office ran smoothly.
        </p>
        <p>
          On the development side, I participated in our tenth discussion with the MIS mentors. We presented the current progress and overall direction of the system, gathering critical feedback for further refinement. This week was slightly shorter due to the Labor Day holiday, but we maintained our productivity through the Friday WFH arrangement.
        </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border-l-4 border-cyan-500 my-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li><strong>IT Technical Support:</strong> Troubleshot internet connectivity, performed printer maintenance, and configured PCs for the FAS division.</li>
            <li><strong>System Refinement:</strong> Adjusted the trajectory of the DOCS system based on the tenth round of mentor evaluations.</li>
            <li><strong>Cross-Functional Work:</strong> Balanced dedicated software development with immediate, hands-on IT helpdesk responsibilities.</li>
            <li><strong>Adaptability:</strong> Navigated a compressed holiday workweek utilizing our established remote work schedule.</li>
          </ul>
        </div>
      </div>
    </div>
